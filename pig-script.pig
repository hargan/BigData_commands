...
REGISTER /home/cloudera/myjars/tutorial.jar;

-- Use the  PigStorage function to load the excite log file into the raw bag as an array of records.
-- Input: (user,time,query) 
--raw = LOAD '/mypig/excite/input/excite.log.bz2' USING PigStorage('\t') AS (user, time, query);
raw = LOAD '/mypig/excite/input/excite-small.log' USING PigStorage('\t') AS (user, time, query);
...
--STORE ordered_uniq_frequency INTO '/mypig/excite/output/' USING PigStorage();DUMP ordered_uniq_frequency
